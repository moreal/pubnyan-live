...
- [x] **Smoke: loop plumbing.** Add the line `loop smoke 2026-09-06` to the end of `docs/backlog-smoke.txt` (create it). Done when: `tail -1 docs/backlog-smoke.txt` prints `loop smoke 2026-09-06` and `npm run check` is green.

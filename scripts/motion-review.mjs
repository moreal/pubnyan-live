...
const selected = clips.filter(c => c.rig === 'pubnyan' && c.name !== 'tail-flick');
...
</style><h1>Pubnyan · Motion review</h1><p>몸체와 링이 따로 살아 움직입니다. 기쁨의 도약, 링을 따라가는 시선, 표정마다 다른 여운을 살펴보세요.</p>
